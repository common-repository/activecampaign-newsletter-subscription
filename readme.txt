...
4. Add Custom Text If you Want, This text will display on SignUP Page with Checkbox. screenshot-1.png
5. If user select This Checkbox, than user will be added to ActiveCampaign. screenshot-2.png
6. User will be added to ActiveCampaign List. screenshot-3.png
